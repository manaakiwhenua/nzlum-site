...
<Tabs>
    ...
    <TabItem label="1.0.0 Conservation and Minimal Use">
        ...
        <LinkButton href="/classification/v0-3/classes/100/class-1"> 1.0.0 Conservation and Minimal Use </LinkButton>
    </TabItem>
    ...
    <TabItem label="2.0.0 Production Agriculture and Plantations">
        ...
        <LinkButton href="/classification/v0-3/classes/200/class-2"> 2.0.0 Production Agriculture and Plantations </LinkButton>
    </TabItem>
    ...
    <TabItem label="3.0.0 Built Environment">
        ...
        <LinkButton href="/classification/v0-3/classes/300/class-3"> 3.0.0 Built Environment </LinkButton>
    </TabItem>
