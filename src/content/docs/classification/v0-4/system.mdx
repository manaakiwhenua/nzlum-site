...
import SummaryDiagram from '../../../../assets/v0.4.0/nzlum_v0.4.0_summary.svg';
...
<SummaryDiagram class="summary-diagram" role="img" aria-label="Summary of the NZLUM v0.4 class hierarchy" />
